...
let TW_discography = new Discography(
  "The Weeknd Albums",
  A_after_hours,
  A_dawn_fm,
);
...
const fumandote_un_blunt = new Song(
  "Fumandote un blunt",
  210,
  "Urban",
  true,
...
let Bejo_discography = new Discography(
  "Bejo Albums",
  BC_tripi_hapa,
  BC_barracudas,
);
...
let DojaCat_discography = new Discography(
  "Doja Cat Albums",
  DC_hot_pink,
  DC_planet_her,
);
