...
(0, vitest_1.describe)('Music Archive Tests', () => {
    ...
    const A_after_hours = new Disc_1.Disc("After Hours", 2020, blinding_lights, save_your_tears, after_hours);
    ...
    (0, vitest_1.test)('should find the singer by name', () => {
        (0, vitest_1.expect)(Library.SearchSinger('The Weeknd')).toStrictEqual([["The Weeknd", 23000000000, "   -After Hours   -Dawn FM",]]);
        (0, vitest_1.expect)(Library.SearchSinger('Unknown')).toBeUndefined();
    });
    (0, vitest_1.test)('should find the disc by name', () => {
        (0, vitest_1.expect)(Library.SearchDisc('After Hours')).toStrictEqual([["After Hours", 'The Weeknd', 2020, "   -Blinding Lights   -Save Your Tears   -After Hours",]]);
        (0, vitest_1.expect)(Library.SearchDisc('Unknown')).toBeUndefined();
    });
    (0, vitest_1.test)('should find the song by name', () => {
        (0, vitest_1.expect)(Library.SearchSong('Blinding Lights')).toStrictEqual([["Blinding Lights", 'The Weeknd', "Pop", 202, 2500000000]]);
