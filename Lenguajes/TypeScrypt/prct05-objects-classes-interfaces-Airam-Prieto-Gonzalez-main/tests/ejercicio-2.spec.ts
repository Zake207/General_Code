...
describe('Music Archive Tests', () => {
        ...
        const A_after_hours = new Disc("After Hours", 2020, blinding_lights, save_your_tears, after_hours);
        ...
        const TW_discography = new Discography("The Weeknd Albums", A_after_hours, A_dawn_fm);
